...
var ChildrenWrapper = styled20.div`
  ...
  height: 100%;
`;
var Backdrop = React27.forwardRef(
  (_a, ref) => {
    var _b = _a, {
      children,
      isOpen,
...
var Modal = React29.forwardRef(
  (_a, ref) => {
    ...
    var _a2;
    const backdropRef = useRef2(null);
    ...
    return /* @__PURE__ */ React29.createElement(backdrop_default, __spreadValues({ ref: backdropRef, isOpen, zIndex }, props), /* @__PURE__ */ React29.createElement(
      container_default,
      {
        height: "100%",
...
var Typeahead = forwardRef3(
  (_a, ref) => {
    ...
    const environment = getDownshiftEnvironment(container);
    const internalInputRef = useRef3(null);
...
import React42, { useState as useState5, useRef as useRef4, useEffect as useEffect9 } from "react";
...
import React47, { useCallback as useCallback4, useMemo as useMemo4, useRef as useRef5, useId } from "react";
...
var IndicatorContainer = styled44.span`
  position: relative;
  display: inline-block;
`;
var IndicatorWrapper = styled44.span`
  position: absolute;
...
`;
var IndicatorDot = styled44.span`
  position: absolute;
  height: 100%;
  width: 100%;
  border-radius: var(--lns-radius-full);
...
var Indicator = (_a) => {
  ...
  const dotElement = /* @__PURE__ */ React55.createElement(IndicatorDot, { withPulse, color });
  return /* @__PURE__ */ React55.createElement(IndicatorContainer, __spreadValues({}, props), children, /* @__PURE__ */ React55.createElement(IndicatorWrapper, null, dotElement));
};
