...
export declare const ModalCard: ({ children, onCloseClick, isOpen, maxWidth, maxHeight, placement, ariaLabel, ariaModal, ariaLabelledBy, ref, removeClose, initialFocus, ...props }: ModalCardProps & {
