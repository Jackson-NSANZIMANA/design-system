...
var write_document_exports = {};
__export(write_document_exports, {
  SvgWriteDocument: () => SvgWriteDocument
});
module.exports = __toCommonJS(write_document_exports);
var import_page = __toESM(require("@atlaskit/icon/core/page"));
var React = __toESM(require("react"));
function SvgWriteDocument() {
  return /* @__PURE__ */ React.createElement(import_page.default, { label: "", testId: "ads-refreshed-icon" });
}
