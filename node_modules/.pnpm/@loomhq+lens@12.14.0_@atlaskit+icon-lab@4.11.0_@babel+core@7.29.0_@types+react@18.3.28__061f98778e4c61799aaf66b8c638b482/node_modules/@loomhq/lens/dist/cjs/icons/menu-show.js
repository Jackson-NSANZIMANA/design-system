...
var menu_show_exports = {};
__export(menu_show_exports, {
  SvgMenuShow: () => SvgMenuShow
});
module.exports = __toCommonJS(menu_show_exports);
var import_sidebar_expand = __toESM(require("@atlaskit/icon/core/sidebar-expand"));
var React = __toESM(require("react"));
function SvgMenuShow() {
  return /* @__PURE__ */ React.createElement(import_sidebar_expand.default, { label: "", testId: "ads-refreshed-icon" });
}
