...
__export(index_exports, {
  ...
  Illustration: () => illustration_default,
  IllustrationAccountsAndBilling: () => accounts_and_billing_default,
  IllustrationArchived: () => archived_default,
  IllustrationAskForMore: () => ask_for_more_default,
  IllustrationBusinessPlan: () => business_plan_default,
  IllustrationChromeNotificationsEmptyState: () => chrome_notifications_empty_state_default,
  IllustrationCollaborateWithTeammates: () => collaborate_with_teammates_default,
  IllustrationComments: () => comments_default,
  IllustrationCommunity: () => community_default,
  IllustrationCommunityAlt: () => community_alt_default,
  IllustrationContentLimit: () => content_limit_default,
  IllustrationCustomBranding: () => custom_branding_default,
  IllustrationDesktopAppAndChromeExtension: () => desktop_app_and_chrome_extension_default,
  IllustrationDeviceCompatibility: () => device_compatibility_default,
  IllustrationDowngrade: () => downgrade_default,
  IllustrationEmbraceTheWeird: () => embrace_the_weird_default,
  IllustrationEnterprisePlan: () => enterprise_plan_default,
  IllustrationFaqAndSecurity: () => faq_and_security_default,
  IllustrationFiveMinuteLimit: () => five_minute_limit_default,
  IllustrationGettingStarted: () => getting_started_default,
  IllustrationGrowthThroughEmpathy: () => growth_through_empathy_default,
  IllustrationHealthPlans: () => health_plans_default,
  IllustrationHelpIos: () => help_ios_default,
  IllustrationHowToUseLoom: () => how_to_use_loom_default,
  IllustrationInvite: () => invite_default,
  IllustrationInviteMembers: () => invite_members_default,
  IllustrationLeadWithTransparency: () => lead_with_transparency_default,
  IllustrationLearningAndDevelopment: () => learning_and_development_default,
  IllustrationLoomPlans: () => loom_plans_default,
  IllustrationMyVideosEmptyStateMobile: () => my_videos_empty_state_mobile_default,
  IllustrationOptionGrants: () => option_grants_default,
  IllustrationParentalLeave: () => parental_leave_default,
  IllustrationPto: () => pto_default,
  IllustrationRecentsEmptyStateMobile: () => recents_empty_state_mobile_default,
  IllustrationRecord: () => record_default,
  IllustrationRemoteFirst: () => remote_first_default,
  IllustrationRoadmap: () => roadmap_default,
  IllustrationScreenshot: () => screenshot_default,
  IllustrationShare: () => share_default,
  IllustrationShareWithYourTeam: () => share_with_your_team_default,
  IllustrationStarred: () => starred_default,
  IllustrationStarterPlusPlan: () => starter_plus_plan_default,
  IllustrationStrongUploadSpeed: () => strong_upload_speed_default,
  IllustrationTroubleshooting: () => troubleshooting_default,
  ...
  arrayToBreakpoints: () => arrayToBreakpoints,
  backgroundColorRules: () => backgroundColorRules,
  borderRules: () => borderRules,
  breakpoints: () => breakpoints,
  buildGlobalStylesheet: () => buildGlobalStylesheet,
  ...
  getAlignmentStyles: () => getAlignmentStyles,
  getAllCssVarsString: () => getAllCssVarsString,
  ...
  getOffsetFocusRing: () => getOffsetFocusRing,
  getPlacement: () => getPlacement,
  getRadius: () => getRadius,
  getResponsiveBoolean: () => getResponsiveBoolean,
  getResponsiveColumns: () => getResponsiveColumns,
  getResponsiveGridSections: () => getResponsiveGridSections,
  getResponsiveNumber: () => getResponsiveNumber,
  getResponsiveOneOf: () => getResponsiveOneOf,
  getShadow: () => getShadow,
  getSize: () => getSize,
  getSizeValue: () => getSizeValue,
  getSizingCssVarsDeclarations: () => getSizingCssVarsDeclarations,
  getSizingVariablesCssVarsObject: () => getSizingVariablesCssVarsObject,
  getSpacingSelectors: () => getSpacingSelectors,
  getTextSize: () => getTextSize,
  getThemeStyles: () => getThemeStyles,
  getThemeStylesString: () => getThemeStylesString,
  getVariablesCssVarsObject: () => getVariablesCssVarsObject,
  gradientVariables: () => gradientVariables,
  gradients: () => gradients,
  growRules: () => growRules,
  ...
  objectToBreakpoints: () => objectToBreakpoints,
  objectToRuleset: () => objectToRuleset,
  overflowRules: () => overflowRules,
  paddingCrossRules: () => paddingCrossRules,
  paddingRules: () => paddingRules,
  pascalCaseToKebabCase: () => pascalCaseToKebabCase,
  positionRules: () => positionRules,
  radii: () => radii,
  radiiRules: () => radiiRules,
  radiusVariables: () => radiusVariables,
  saturate: () => saturate,
  shadowRules: () => shadowRules,
  shadowVariables: () => shadowVariables,
  shadows: () => shadows,
  shortBreakpoints: () => shortBreakpoints,
  shrinkRules: () => shrinkRules,
  sidePositionRules: () => sidePositionRules,
  spaceVariables: () => spaceVariables,
  spaces: () => spaces,
  textAlignmentRules: () => textAlignmentRules,
  textSizeRules: () => textSizeRules,
  textSizeVariables: () => textSizeVariables,
  textSizes: () => textSizes,
  textVariantRules: () => textVariantRules,
  themeColors: () => themeColors,
  u: () => u,
  unit: () => unit,
  unitVariables: () => unitVariables,
  useFocusedElement: () => useFocusedElement,
  useMedia: () => useMedia,
  useOnClickOutside: () => useOnClickOutside,
  usePreventScroll: () => use_prevent_scroll_default,
...
function useMedia(queries, values, defaultValue) {
  const match = import_react.default.useCallback(() => {
    if (typeof window === "undefined") {
      return defaultValue;
    }
    return values[queries.findIndex((q) => matchMedia(q).matches)] || defaultValue;
  }, [defaultValue, queries, values]);
  const [value, set] = import_react.default.useState(match);
  import_react.default.useEffect(() => {
    const handler = (0, import_debounce.default)(() => set(match), 150);
...
var TextWrapper = import_styled.default.span`
...
var AvatarWrapper = import_styled2.default.span`
  display: block;
...
`;
var AvatarImage = import_styled2.default.img`
  max-width: 100%;
  width: ${(props) => {
  const { width } = getAvatarSize(props.size);
  return width;
...
var Avatar = (_a) => {
  ...
  const getContent = () => {
    ...
    if (letter) {
      if (altText) {
        return /* @__PURE__ */ import_react3.default.createElement("span", { "aria-label": altText }, letter);
      }
      return letter;
    }
  };
...
var import_trace_press = __toESM(require("@atlaskit/react-ufo/trace-press"));

// src/components/icon/icon.tsx
var import_styled3 = __toESM(require("@emotion/styled"));
var import_react6 = __toESM(require("react"));
var defaultIconSize = 3;
var IconWrapper = import_styled3.default.span`
  display: block;
...
var dotScale = import_react7.keyframes`
  50% {
    transform: scale(1);
  }
`;
var LoaderWrapper = import_styled4.default.span`
  display: inline-block;
  vertical-align: middle;
  height: ${(props) => getTotalSize(props)}px;
  width: ${(props) => getTotalSize(props)}px;
`;
var Dots = import_styled4.default.span`
  display: grid;
  grid-template-areas: 'stack';
  height: 100%;
  width: 100%;
`;
var DotWrapper = import_styled4.default.span`
  grid-area: stack;
  place-self: center;
...
`;
var Dot = ({ position, color, size }) => /* @__PURE__ */ import_react8.default.createElement(DotWrapper, { color, position, size });
var Loader = (_a) => {
  var _b = _a, {
    color = "body",
    size = "medium"
  ...
  for (i = 0; i < dotsAmount; i++) {
    dotsList.push(/* @__PURE__ */ import_react8.default.createElement(Dot, { color, position: i, size, key: i }));
  }
  return /* @__PURE__ */ import_react8.default.createElement(LoaderWrapper, __spreadValues({ size }, props), /* @__PURE__ */ import_react8.default.createElement(Dots, null, dotsList));
};
...
var hasLoaderStyles = (props) => import_react9.css`
...
var widthStyles = (props) => ({
  auto: import_react9.css`
    display: inline-flex;
    min-width: ${sizesStyles[props.size].height};
  `,
  full: import_react9.css`
    display: flex;
    width: 100%;
  `,
  maxContent: import_react9.css`
    display: inline-flex;
    width: max-content;
...
var LogoImage = import_styled5.default.img`
  ...
  ${hasLoaderStyles};
`;
var LoaderSection = import_styled5.default.span`
  position: relative;
  display: flex;
  align-items: center;
`;
var ChildrenSection = import_styled5.default.span`
  ${hasLoaderStyles};
`;
var Button = (_a) => {
  var _b = _a, {
  ...
  const onClickWithPressTracing = (0, import_react10.useCallback)(
    (event) => {
      if (interactionName) {
        (0, import_trace_press.default)(interactionName);
      }
...
var SpacerWrapper = import_styled6.default.div`
...
var LinkWrapper = import_styled22.default.a`
  ...
  transition: 0.3s box-shadow;
  ${(props) => props.noWrap && import_react29.css`
      white-space: nowrap;
    `}
  &:hover {
...
var Popover = (_a) => {
  ...
  const { stage, shouldMount } = (0, import_transition_hook2.useTransition)(
    isOpen,
  ...
  const { x, y, reference, floating, strategy, update, refs } = (0, import_react_dom.useFloating)({
    ...
    middleware: [
      ...
      (0, import_react_dom.offset)(unitOffset)
    ],
    strategy: "fixed"
  });
  (0, import_react53.useEffect)(() => {
    ...
    return (0, import_react_dom.autoUpdate)(refs.reference.current, refs.floating.current, update);
...
var ringAnimation = import_react62.keyframes`
  0% {
    transform: scale(1);
    opacity: 0;
  }
...
var IndicatorContainer = import_styled44.default.span`
  position: relative;
  display: inline-block;
`;
var IndicatorWrapper = import_styled44.default.span`
  position: absolute;
...
`;
var IndicatorDot = import_styled44.default.span`
  position: absolute;
  height: 100%;
  width: 100%;
  border-radius: var(--lns-radius-full);
  background-color: ${(props) => colorStyles2[props.color || "blue"]};
...
var Indicator = (_a) => {
  ...
  const dotElement = /* @__PURE__ */ import_react63.default.createElement(IndicatorDot, { withPulse, color });
  return /* @__PURE__ */ import_react63.default.createElement(IndicatorContainer, __spreadValues({}, props), children, /* @__PURE__ */ import_react63.default.createElement(IndicatorWrapper, null, dotElement));
};
...
function IllustrationRoadmap(props) {
  return /* @__PURE__ */ React76.createElement(
    ...
    /* @__PURE__ */ React76.createElement("path", { d: "M100 100H0V0h100v100zM10 90h80V10H10v80z", fill: "currentColor" }),
...
function IllustrationSharewithYourTeamTeamLibrary(props) {
  return /* @__PURE__ */ React80.createElement(
    ...
    /* @__PURE__ */ React80.createElement(
      ...
      /* @__PURE__ */ React80.createElement("path", { d: "M33.33 24.946V8.384L24.946 0v24.946H0l8.384 8.384H33.33v-8.384zM58.286 33.33h8.385V8.384L58.286 0v24.946H33.331l8.394 8.384h16.561z" }),
      /* @__PURE__ */ React80.createElement("path", { d: "M100 8.384L91.614 0v24.946H66.67l8.385 8.384H100V8.384zM33.33 58.286V41.724l-8.384-8.394v24.956H0l8.384 8.384H33.33v-8.384zM33.33 58.286l8.395 8.384H66.67V41.724l-8.385-8.394v24.956H33.331zM66.67 58.286l8.384 8.384H100V41.724l-8.385-8.394v24.956H66.67zM24.946 66.67v24.946H0L8.384 100H33.33V75.054l-8.384-8.384zM58.286 66.67v24.946H33.331L41.725 100H66.67V75.054l-8.385-8.384zM66.67 91.616L75.053 100h24.945V75.054l-8.384-8.384v24.946H66.67z" })
    ),
    /* @__PURE__ */ React80.createElement("defs", null, /* @__PURE__ */ React80.createElement("clipPath", { id: "Share_with_Your_Team_(Team_Library)_svg__clip0" }, /* @__PURE__ */ React80.createElement("path", { fill: "#fff", d: "M0 0h100v100H0z" })))
  );
}
...
function IllustrationFaQandSecurity(props) {
  return /* @__PURE__ */ React83.createElement(
    ...
    /* @__PURE__ */ React83.createElement("path", { d: "M31 50V0H0v100h99.999V69H31V50z", fill: "currentColor" }),
    /* @__PURE__ */ React83.createElement("path", { d: "M100 66V0H34v31h35v35h31z", fill: "currentColor" })
  );
}
...
function IllustrationWellness(props) {
  return /* @__PURE__ */ React97.createElement(
    ...
    /* @__PURE__ */ React97.createElement("path", { fill: "currentColor", d: "M100 67.595H66.667v33.333H100z" })
  );
}
...
function IllustrationMyVideosEmptyStateMobile(props) {
  return /* @__PURE__ */ React101.createElement(
    ...
    /* @__PURE__ */ React101.createElement("path", { d: "M96 0H0v96h96V0zM84 12v72H12V12h72z", fill: "currentColor" }),
...
function IllustrationChromeNotificationsEmptyState(props) {
  return /* @__PURE__ */ React103.createElement(
    ...
    /* @__PURE__ */ React103.createElement("circle", { cx: 80.16, cy: 15.84, r: 15.84, fill: "currentColor" }),
    /* @__PURE__ */ React103.createElement(
      "path",
      {
