...
var comment_add_exports = {};
__export(comment_add_exports, {
  SvgCommentAdd: () => SvgCommentAdd
});
module.exports = __toCommonJS(comment_add_exports);
var import_comment_add = __toESM(require("@atlaskit/icon/core/comment-add"));
var React = __toESM(require("react"));
function SvgCommentAdd() {
  return /* @__PURE__ */ React.createElement(import_comment_add.default, { label: "", testId: "ads-refreshed-icon" });
}
